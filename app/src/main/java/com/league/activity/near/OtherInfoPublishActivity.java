...
public class OtherInfoPublishActivity extends BaseActivity implements View.OnClickListener, IContants {
    @Bind(R.id.near_back)
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == imgList.size() - 1) {
                    ...
                    Intent intent = new Intent(OtherInfoPublishActivity.this, ShowBigImgActivity.class);
    ...
    private void pickImage() {
        Intent intent = new Intent(OtherInfoPublishActivity.this, MultiImageSelectorActivity.class);
        // 是否显示调用相机拍照
    ...
    private OnAllComplete onAllComplete = new OnAllComplete() {
        ...
        public void allComplete(boolean result) {
            ...
            imgStr = imgStr.trim();
            ApiUtil.otherCreated(getApplicationContext(), title, content, imgStr, new JsonHttpResponseHandler() {
                @Override
                public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                    closeProgressDialog();
