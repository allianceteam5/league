...
public class TenyuanGrab extends BaseActivity {
    ...
    private int type = 0;
    private TenYuanGrabAdapter tenYuanGrabAdapter;
    ...
    private void initData(int type, final int currentPage) {
        ApiUtil.grabcornsSearch(getApplication(), type, currentPage, new BaseJsonHttpResponseHandler<ArrayList<TenYuanGrabBean>>() {
            @Override
    ...
    void updateTenYuan() {
        tenYuanGrabAdapter.notifyDataSetChanged();
